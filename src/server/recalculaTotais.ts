...
import { LinhaETotais, LinhaPlanilhaPontos, Totais, TotaisNum } from "../types/Pontos.js";
import { minutosToTempo, tempoToMinutos } from "./tempo.js";
import { totaisToString } from "./totaisToString.js";


export function recalculaTotais(linha: LinhaPlanilhaPontos, totais: Totais, config: Config): LinhaETotais{
